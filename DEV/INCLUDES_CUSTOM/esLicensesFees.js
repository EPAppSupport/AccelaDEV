function esLicensesFees() {
	...
	if (appMatch('Licenses/Security Alarm/NA/NA') && wfTask appMatch('Licenses/Security Alarm/NA/NA') && wfTask == 'Application Submittal' && wfStatus == 'Completed') {
		...
		if (appMatch(' Licenses / Food / NA / NA ') && wfTask == ' Application Submittal ' && wfStatus == ' Completed ' && AInfo[' License Type '] == ' Meat Establishment,
		Warehouse,
		...
		if (asiRow['Class'] == 'CB-Caterer' s After 3rd year ') {
			...
			if (appMatch(' Licenses / Flea Market /*/
			 * ') && wfTask == ' Completeness Check ' && wfStatus == ' Approved ' && AInfo[' Renewal '] == ' Yes ') {
			...
			if (appMatch(' Licenses / Flea Market /*/
			 * ') && wfTask == ' Completeness Check ' && wfStatus == ' Approved ' && AInfo[' Renewal '] == ' No ') {
